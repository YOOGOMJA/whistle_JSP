...
<body ng-controller='comMainCtrl'>
    ...
    <section class='body'>
        <md-content>
            ...
            <md-content flex layout-padding class='team-info empty team'>
                <div class='cover'>
                    <h1 class='md-headline center warn' ng-bind='mod.team.info.teamName'></h1>
                    <md-button class="md-raised md-primary btn" ng-click='evt.team.create()'>More Team Info</md-button>
                </div>
            </md-content>
